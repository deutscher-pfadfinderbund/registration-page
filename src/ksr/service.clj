    ...
    [:div.container
     [:div.row
      ...
      [:div.col-md-10.col-sm-10.card.card-3
       ...
       [:p "Bei Anreise mit dem " [:strong "Auto"] " parkt ihr bitte dem P&R Parkplatz am Bahnhof Güldenwerth und wandert die paar Meter zum Kotten."]
       [:div.myIframe
...
(def routes #{["/" :get (conj common-interceptors `register-page)]})
